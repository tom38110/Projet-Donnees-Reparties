...
public class Project {
	...
	public static int nbNoeud = 6;
	public static String hosts[] = {"localhost", "localhost", "localhost", "localhost", "localhost", "localhost"};
	public static int ports[] = {8081, 8082, 8083, 8084, 8085, 8086};
	public static int portWorker = 8087;
